OC.L10N.register(
    ...
    "Allow collecting data for all requests in debug mode (all users, unauthenticated requests)" : "Дозволете собирање на податоци за сите барање во режим за дебагирање (за сите корисници, неовластени барања)",
