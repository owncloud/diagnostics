OC.L10N.register(
    ...
    "All queries (summary, single queries with their parameters)" : "Todas las consultas (resumen, todas las consultas con sus parámetros)",
    ...
    "Allow collecting all data (including unauthenticated requests, debug mode)" : "Permitir recoger todos los datos (incluyendo peticiones sin auntentificació, modalidad debug)",
    ...
    "The logfile is empty!" : "El fichero de registro está localizado por defecto en ./data/diagnostic.log",
